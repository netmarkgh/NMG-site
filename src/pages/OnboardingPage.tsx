...
import { 
  ...
  Upload, User, MapPin, Globe, Briefcase, 
  MessageCircle, Target, TrendingUp, HelpCircle
} from 'lucide-react';
...
export default function OnboardingPage() {
  ...
  if (isSuccess) {
    ...
    return (
      <div className="min-h-screen bg-brand-white font-onboarding flex flex-col items-center justify-center p-6 text-center">
              ...
              >
                ...
                {step === 2 && (
                  <>
                    ...
                    <div className="space-y-2">
                      <label className="text-xs font-bold text-brand-grey uppercase tracking-wider">Current Marketing Situation *</label>
                      <select 
                        className="w-full bg-[#F7F6F2] border-2 border-brand-border rounded-xl px-4 py-3 text-sm focus:border-brand-gold focus:bg-white outline-none transition-all appearance-none"
